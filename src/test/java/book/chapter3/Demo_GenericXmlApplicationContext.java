...
public class Demo_GenericXmlApplicationContext {
	public static void main(String[] args) {
		...
		gxac.load(
				"classpath:/book/h_applicationContext-scanpackage.xml");
		...
		//xml注入
		gxac2.load("/book/h_applicationContext.xml");
		gxac2.refresh();
		book.chapter2.MessageReader mr2 = gxac2.getBean("reader" , book.chapter2.MessageReader.class);
		mr2.reader();
